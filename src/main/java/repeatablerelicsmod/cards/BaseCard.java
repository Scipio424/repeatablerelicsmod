package repeatablerelicsmod.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import repeatablerelicsmod.repetablerelics;
import repeatablerelicsmod.util.CardStats;
import repeatablerelicsmod.util.TriFunction;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return repetablerelics.makeID(name); }
    ...
    public BaseCard(String ID, CardStats info, String cardImage) {
        this(ID, info.baseCost, info.cardType, info.cardTarget, info.cardRarity, info.cardColor, null);
    }
    public BaseCard(String ID, int cost, CardType cardType, CardTarget target, CardRarity rarity, CardColor color) {
        this(ID, cost, cardType, target, rarity, color, null);
    }
    ...
    {
        super(ID, getName(ID), "", cost, getInitialDescription(ID), cardType, color, rarity, target);
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    repetablerelics.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
