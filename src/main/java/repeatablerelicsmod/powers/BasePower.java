package repeatablerelicsmod.powers;

// import repetablerelicsmod.util.TextureLoader; // Commented out as textures are not required
import com.badlogic.gdx.graphics.Color;
// import com.badlogic.gdx.graphics.Texture; // Commented out as textures are not required
import com.badlogic.gdx.graphics.g2d.SpriteBatch;
// import com.badlogic.gdx.graphics.g2d.TextureAtlas; // Commented out as textures are not required
...
public abstract class BasePower extends AbstractPower {
    ...
    public BasePower(String id, PowerType powerType, boolean isTurnBased, AbstractCreature owner, AbstractCreature source, int amount, boolean initDescription) {
        this(id, powerType, isTurnBased, owner, source, amount, initDescription, false);
    }
